...
export default function DisplayMainItem(props: {
  items: Product;
  getId: (num: number) => void;
  getVal: (num: number, itemPrice: number) => void;
}) {
  return (
      ...
      <View style={styles.cardsty}>
        ...
        <View style={styles.contentcontainer}>
          ...
          <View style={styles.priceContainer}>
            <Text style={{ fontWeight: "600" }}>${props.items.price}</Text>
          </View>
        </View>
        <TouchableOpacity
          style={styles.editButton}
          onPress={() => {
            props.getVal(props.items.id, props.items.price);
          }}
        >
